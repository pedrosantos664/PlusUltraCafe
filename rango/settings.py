...
SECRET_KEY = 'django-insecure-z6u^m=$&(9f&ti6-5be5a)nb3)dnyyq&ws7#!-h_fvdil_t7h4'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'janela.context_processors.auth_status', 
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'janela/templates/janela'),  
]
